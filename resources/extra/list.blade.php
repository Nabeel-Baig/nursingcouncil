            ...
            <div class="card">
                <div class="card-body">
                    <div class="float-right">
                        ...
                        @endcan
                        @can('sub_lead_create')
                            <a class="btn btn-info" href="{{ route('admin.assigned-leads.create') }}">Add</a>
                        @endcan
                    </div>
                    <table id="example1" class="table table-striped table-bordered dt-responsive nowrap">
                        <thead>
                            <tr>
                                ...
                                <th>Sub Lead Id</th>
                                <th>Sub Lead Image</th>
                                <th>Sub Lead Name</th>
                                <th>Sub Lead Email</th>
                                <th>Sub Lead Phone</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody></tbody>
...
@section('script-bottom')
    <script>
        $(function () {
            // var source = `{{ route('admin.'.request()->segment(2).'.show',$id) }}`;
            var source = `{{ url('admin/'.request()->segment(2).'/showById/'.$id) }}`;
            ...
            $(document, this).on('click', '.view', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        document.getElementById('country').innerText = data.lead_country;
                        document.getElementById('city').innerText = data.lead_city;
                        document.getElementById('state').innerText = data.lead_state;
                        document.getElementById('website').innerText = data.lead_website;
                        document.getElementById('brand').innerText = data.brand.brand_name;
