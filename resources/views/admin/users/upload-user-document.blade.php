        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.users.upload-'.request()->segment(2), $id) }}" class="custom-validation"
                        ...
                        <div class="mb-3">
                            <label class="form-label">{{ ucwords(str_replace('-', ' ', request()->segment(2))) }}</label>
