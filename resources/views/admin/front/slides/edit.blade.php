        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.slides.update',[$slide->id]) }}" class="custom-validation" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        {{-- ========================== --}}
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('slide_details') parsley-error @enderror"
                                   name="slide_details" id="slide_details" placeholder="{{ ucwords(str_replace('_',' ','Details')) }}" value="{{ $slide->slide_sub_title }}" required/>
                            @error('slide_details')
                            <span class="text-red">{{ $message }}</span>
                            @enderror
                        </div>
