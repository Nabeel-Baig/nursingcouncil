            ...
            <div class="card">
                <div class="card-body">
                    <div class="float-right">
                        {{-- {{ $id }} --}}
                        <a class="btn btn-info" href="{{ url('admin/card-slides/create', $id) }}">Add</a>
                    </div>
...
@section('script-bottom')
    <script>
        var DataTable = '';
        $(function() {
            var source = `{{ url('admin/cards/showAllById/' . $id) }}`;
        ...
        $(document).on('click', '#ok_delete', function() {
            let url = '{{ route('admin.card-slides.destroy', ':id') }}'
            $.ajax({
                type: "delete",
        ...
        function checkRow(){
            ...
            if(count <= 3){
                $('.delete btn btn-danger btn-sm').prop('disabled', true);
            }
            return
