        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.news-updates.store') }}" class="custom-validation"
                        ...
                        <div class="mb-3">
                            <label class="form-label">{{ ucwords(str_replace('_',' ','Website link')) }}</label>
                             <input type="text" class="form-control @error('web_link') parsley-error @enderror"
                                   name="web_link" id="web_link" placeholder="{{ ucwords(str_replace('_',' ','website_link')) }}" value="{{ old('web_link') }}"/>
                            @error('web_link')
                            <span class="text-red">{{ $message }}</span>
                            @enderror
                        </div>
