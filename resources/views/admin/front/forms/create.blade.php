        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.forms.store') }}" class="custom-validation"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea required name="description" id="technig" rows="5" cols="40" class="form-control">{{ old('description') }}</textarea>
                            @error('description')
                                <span class="text-red">{{ $message }}</span>
                            @enderror
                        </div>
