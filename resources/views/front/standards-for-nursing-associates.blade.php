        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12 m-auto text-center">
                    <h2 class="innerMainTitle">Standards for nursing associates</h2>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row pt-5">
                ...
                <div class="col-lg-4 mb-4">
                    <a href="javascript:void(0);" class="postImageCard">
                        <div class="ourWorkCard h-100 pb-3 shadow">
                            <img src="{{ asset($slide->slide_image) }}" alt="Standards of proficiency for registered nursing associates" title="Standards of proficiency for registered nursing associates">
                            <div class="card-body">
                ...
                {{-- <div class="col-lg-4 mb-4">
                    <a href="javascript:void(0);" class="postImageCard">
                        <div class="ourWorkCard h-100 pb-3 shadow">
                            <img src="{{ asset('front_assets/images/nursing-associates/1.jpg') }}" alt="Standards of proficiency for registered nursing associates" title="Standards of proficiency for registered nursing associates">
                            <div class="card-body">
                                <div class="card-title mb-0">
                                    <h5 class="mb-0"><b>Standards of proficiency for registered nursing associates</b></h5>
                                    <p class="p-0 mt-2">
                                        Our standards of proficiency set out the knowledge and skills that a nursing associate needs to meet.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 mb-4">
                    <a href="javascript:void(0);" class="postImageCard">
                        <div class="ourWorkCard h-100 pb-3 shadow">
                            <img src="{{ asset('front_assets/images/nursing-associates/2.jpg') }}" alt="Standards framework for nursing and midwifery education" title="Standards framework for nursing and midwifery education">
                            <div class="card-body">
                                <div class="card-title mb-0">
                ...
                <div class="col-lg-4 mb-4">
                    <a href="javascript:void(0);" class="postImageCard">
                        <div class="ourWorkCard h-100 pb-3 shadow">
                            <img src="{{ asset('front_assets/images/nursing-associates/3.jpg') }}" alt="Standards for student supervision and assessment" title="Standards for student supervision and assessment">
                            <div class="card-body">
                                <div class="card-title mb-0">
            ...
            <div class="col-lg-8 m-auto">
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        <a href="javascript:void(0);" class="postImageCard">
                            <div class="ourWorkCard h-100 pb-3 shadow">
                                <img src="{{ asset($subSlide->slide_image) }}" alt="Standards for pre-registration nursing associate programmes" title="Standards for pre-registration nursing associate programmes">
                                <div class="card-body">
                                    <div class="card-title mb-0">
                    ...
                    {{-- <div class="col-lg-6 mb-4">
                        <a href="javascript:void(0);" class="postImageCard">
                            <div class="ourWorkCard h-100 pb-3 shadow">
                                <img src="{{ asset('front_assets/images/nursing-associates/5.jpg') }}" alt="Standards relating to return to practice" title="Standards relating to return to practice">
                                <div class="card-body">
                                    <div class="card-title mb-0">
